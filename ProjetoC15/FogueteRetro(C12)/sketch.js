let rocket;
let star1Img, star2Img, rocketImg, powerImg, delayImg, asteroidImg;
let gameState = "serve";
let score = 0;
...
function draw() {
  ...
  if(gameState == "end"){
    ...
    delaysGroup.setVelocityXEach(0);
    ...
    powersGroup.setLifetimeEach(0);
    delaysGroup.setLifetimeEach(0);
...
function base(){
  ...
  if(rocket.isTouching(delaysGroup)){
    delaysGroup.destroyEach();
    TimeWorld = 0;
  }
  if(gun == "lvl1"){
